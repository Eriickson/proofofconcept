...
const PortfolioFiscalReport = () => {
  ...
  useEffect(() => {
    ...
    if (!isLoaded || typeof reporting === "undefined" || reporting.length === 0) {
      return <div>Cargando ...</div>;
    }

      return (
        <DocumentTitle title='IronIA - Información fiscal'>
          <>
...
export default PortfolioFiscalReport;
